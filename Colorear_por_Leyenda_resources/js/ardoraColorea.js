...
};imageObj.src ="Colorear_por_Leyenda_resources/media/tangram-en-blanco.jpg";
...
var canvas = document.getElementById("ardoraCanvasPaint");var context=canvas.getContext("2d");
for (var i=0;i<x.length;i++) {indexColor=i;fillArea(parseInt(x[i]),parseInt(y[i]),canvas.width,canvas.height,context);}
}
function paintBack(){}
